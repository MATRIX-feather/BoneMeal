...
public class TreeCommand implements ISubCommand
{
    ...
    @NotNull
    private FormattableMessage helpDescription = new FormattableMessage(FeatherExperience.getInstance(), "Nil");
        ...
        private static class BuildMeta
        {
            ...
            public TreeCommand toCmd()
            {
                ...
                instance.helpDescription = (this.helpMessage == null)
                        ? new FormattableMessage(FeatherExperience.getInstance(), "Nil")
                        : this.helpMessage;
