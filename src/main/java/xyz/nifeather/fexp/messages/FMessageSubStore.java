...
public class FMessageSubStore extends MessageStore<FeatherExperience>
{
    public FMessageSubStore(String locale, List<Class<? extends IStrings>> strings, FMessageStore parentStore)
    {
        this.locale = locale;
    ...
    private final FMessageStore parentStore;
