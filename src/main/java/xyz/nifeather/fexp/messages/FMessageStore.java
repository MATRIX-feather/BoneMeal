...
public class FMessageStore extends MessageStore<FeatherExperience>
{
    private final List<Class<? extends IStrings>> strings = ObjectList.of(
    );

    private final Map<String, FMessageSubStore> subStores = new Object2ObjectOpenHashMap<>();
    ...
    private FMessageSubStore getOrCreateSubStore(String locale)
    {
        ...
        synchronized (subStores)
        {
            ...
            store = new FMessageSubStore(locale, strings, this);
